...
<body>
    ...
    <div class="main-container p-5">
        ...
        <center>
            <div class="permohonan max-w-4xl md:px-10 pt-5">
                <?php 
                                ...
                                <div class="flex flex-col">
                                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                                        <div class="inline-block min-w-full sm:px-6 lg:px-8">
                                                                ...
                                                                <tr class="border-b dark:border-neutral-500">
                                                                    ...
                                                                    <td class="whitespace-nowrap px-6 py-4 font-medium">
                                                                        <?php echo $bahan['nama_bahan'] ?><a
                                                                            href="../bahan/kemaskini-bahan.php?id_bahan=<?php echo $bahanId?>"
                                            ...
                                            <?php 
                                                $padding = "";
                                                if($permohonan['status_permohonan'] == 1 || $permohonan['status_permohonan'] == 2){
                                                    $padding = "p-2";
                                                    $flex = "md:flex";
                                                }
                                            ?>
                                            <div class="<?php echo $flex?>">
                                                <div class="action-buttons md:flex w-full">
                                                    <?php 
                                                        if($permohonan['status_permohonan'] != 2){
                                                            ?>
                                                            <form class="w-full <?php echo $padding?>" action="../backend/permohonan.php" method="post">
                                                                <input type="hidden" name="token" value="<?php echo $token?>">
                                                                <input type="hidden" name="id_permohonan" value="<?php echo $id_permohonan?>">
                                                                <button name="sahkan" type="submit" class="w-full mt-5 inline-block rounded bg-success px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#14a44d] transition duration-150 ease-in-out hover:bg-success-600 hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:bg-success-600 focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] focus:outline-none focus:ring-0 active:bg-success-700 active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.3),0_4px_18px_0_rgba(20,164,77,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(20,164,77,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(20,164,77,0.2),0_4px_18px_0_rgba(20,164,77,0.1)]">Sahkan</button>
                                                            </form>
                                                            <?php
                                                        }
                                                    ?>
                                                    <?php 
                                                        if($permohonan['status_permohonan'] != 0){
                                                            ...
                                                            <form class="w-full <?php echo $padding?>" action="../backend/permohonan.php" method="post">
                                                                <input type="hidden" name="token" value="<?php echo $token?>">
                                                                <input type="hidden" name="id_permohonan" value="<?php echo $id_permohonan?>">
                                                                <button name="batalkan" type="submit" class="w-full mt-5 inline-block rounded bg-danger px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#dc4c64] transition duration-150 ease-in-out hover:bg-danger-600 hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:bg-danger-600 focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] focus:outline-none focus:ring-0 active:bg-danger-700 active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.3),0_4px_18px_0_rgba(220,76,100,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(220,76,100,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(220,76,100,0.2),0_4px_18px_0_rgba(220,76,100,0.1)]">Batal</button>
                                                            </form>
                                                            <?php
