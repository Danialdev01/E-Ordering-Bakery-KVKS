<?php 
  ...
  if(isset($_COOKIE['eOrderingCookie'])){
    ...
    $_SESSION['id_admin_session'] = $eOrderingCookieValue['id_admin'];

  }

  // check kalau ada session
  if(isset($_SESSION['login_status_session']) && isset($_SESSION['id_admin_session'])){

    // kalau login_status tak sama
    if($_SESSION['login_status_session'] != "LoggedInAdmin"){
      ...
      data-te-navbar-nav-ref>
        ...
        <li
          ...
          <a
            class="text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-neutral-400"
            aria-current="page"
            href="<?php echo $location_index?>/admin/permohonan"
            data-te-nav-link-ref
            >Permohonan</a
          >
        </li>
        ...
        <li
          ...
          <a
            class="text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-neutral-400"
            aria-current="page"
            href="<?php echo $location_index?>/admin/pembelian"
            data-te-nav-link-ref
            >Pembelian</a
          >
        </li>
        ...
        <li
          ...
          <a
            class="text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400 lg:px-2 [&.active]:text-black/90 dark:[&.active]:text-neutral-400"
            aria-current="page"
            href="<?php echo $location_index?>/admin/bahan"
            data-te-nav-link-ref
            >Bahan</a
          >
        </li>
...
<?php
  ...
  if($prompt != ""){
      echo '<br><div class="flex justify-center"><div
